...
//            }
//
//            do {            // Nr des Knotenpunkts
//                consoleClear();
//                System.out.printf("Knotenpunkt : %S\n\n", name);
//                nr = readInt("Bitte geben Sie die Paket Nr an ('0' zum Abbrechen): ");
//            } while (nr < 0);
//            consoleClear();
//
//            if (nr == 0) {
...
//
//            if (choice == 1) {
//                arrayWithDependencies = addDependencies(networkplan, nr);
//            } else {
...
//        }
//
//            Process process = new Process(name, nr, duration, arrayWithDependencies);
